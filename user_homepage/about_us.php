        ...
        <div class="section-container">
            <div class="columns content">
                <div class="content-container2">
                    <h4>Nền tảng</h4>
                    <p>
                        Website được phát triển để đảm bảo rằng bạn có trải nghiệm đặt hàng tốt nhất. Bạn có thể liên hệ
                        với shop qua:
                    </p>
                    <ul>
                        <li> Facebook: <a href="https://www.facebook.com/trongchinh.nguyen.14661/" target="_blank"
                                style="color: black;">Cơm bình dân </a></li>
